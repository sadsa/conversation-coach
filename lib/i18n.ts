...
const TRANSLATIONS: Record<UiLanguage, Record<string, string>> = {
  ...
  'practice.incomingHint': "Answer and say hi. They'll take it from there.",
    ...
    'drill.reviewStudiedQuestion': 'Feeling comfortable with this phrase?',
    'drill.reviewStudiedYes': 'Yes',
    'drill.reviewStudiedNo': 'Not yet',
    'drill.reviewKeep': 'Save a recording of this practice',
    'drill.reviewFinishSave': 'Save & finish',
    'drill.reviewFinish': 'Finish',
    ...
    'review.filter.searchPlaceholder': 'Search reviews…',
    ...
    'session.removePrompt': 'Remove this review?',
    ...
    'transcript.savePhrase': 'Save a phrase',
    'transcript.finishReview': 'Finish review',
    'transcript.emptyPartial': 'Keep going — save anything worth practising',
    'transcript.emptyNothingKept': 'Nothing saved — you can remove this review',
    ...
    'vocabulary.studyNow': 'Study now',
    'vocabulary.fromRealLife': 'From real life',
    'vocabulary.section.due': 'Due for review',
    'vocabulary.section.toStudy': 'To study',
    'vocabulary.section.studied': 'Studied',
    'vocabulary.itemsSuffix': 'phrases',
    'vocabulary.noMatches': 'No phrases match your filters.',
    ...
    'onboarding.languageSelect.targetLanguageAria': "Language you're learning",
    ...
    'onboarding.install.body':
      'One tap from your home screen. No browser bar.',
    ...
    'lesson.completeSub': 'Come back whenever you’re ready.',
  ...
  'practice.incomingHint': 'Atendé y saludá. Te van a contar.',
    ...
    'review.filter.searchPlaceholder': 'Buscar conversaciones…',
    'review.filter.button': 'Filtrar',
    'review.filter.inProgress': 'En progreso',
    'review.filter.readyToStudy': 'Para estudiar',
    'review.tab.open': 'Para revisar',
    'review.tab.reviewed': 'Revisadas',
    'review.tab.reviewedEmpty': 'Todavía no revisaste ninguna.',
    'review.search.noneHere': 'Sin coincidencias acá.',
    'review.search.seeOther': 'Ver {count} en {tab}',
    'review.search.noMatches': 'Nada coincide con “{query}”.',
    ...
    'session.removePrompt': '¿Eliminar esta revisión?',
    ...
    'transcript.savePhrase': 'Guardar una frase',
    'transcript.finishReview': 'Terminar revisión',
    'transcript.emptyPartial': 'Seguí revisando — guardá lo que vale la pena practicar',
    'transcript.emptyNothingKept': 'Nada guardado — podés borrar esta revisión',
    ...
    'vocabulary.studyNow': 'Estudiar ahora',
    'vocabulary.fromRealLife': 'De la vida real',
    'vocabulary.section.due': 'Para repasar',
    'vocabulary.section.toStudy': 'Para estudiar',
    'vocabulary.section.studied': 'Estudiado',
    'vocabulary.itemsSuffix': 'frases',
    'vocabulary.noMatches': 'Ninguna frase coincide con tus filtros.',
    'vocabulary.clearFilters': 'Limpiar filtros',
    ...
    'onboarding.languageSelect.targetLanguageAria': 'Idioma que estás aprendiendo',
    ...
    'onboarding.install.body':
      'Un toque desde tu pantalla de inicio. Sin barra del navegador.',
    ...
    'lesson.completeSub': 'Volvé cuando quieras.',
