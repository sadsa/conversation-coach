...
const TRANSLATIONS: Record<UiLanguage, Record<string, string>> = {
  en: {
    ...
    'settings.autoOpenFirstCorrection': 'Open first correction automatically',
    'settings.autoOpenFirstCorrectionHelp': 'When you open a session, show the first correction right away.',
  ...
  es: {
    ...
    'settings.review': 'Revisión',
    'settings.autoOpenFirstCorrection': 'Abrir automáticamente la primera corrección',
    'settings.autoOpenFirstCorrectionHelp': 'Cuando abrís una sesión, mostrará la primera corrección de inmediato.',
