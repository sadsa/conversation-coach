...
const TRANSLATIONS: Record<UiLanguage, Record<string, string>> = {
  en: {
    ...
    'practice.endingState': 'Wrapping up the conversation…',
    ...
    'practice.end': 'End early',
    'practice.endAria': 'End practice session',
    'practice.shortcutHint': 'Esc to end · Space to mute',
  ...
  es: {
    ...
    'practice.endingState': 'Cerrando la conversación…',
    ...
    'practice.end': 'Terminar antes',
    'practice.endAria': 'Terminar la sesión de práctica',
    'practice.shortcutHint': 'Esc para terminar · Espacio para silenciar',
