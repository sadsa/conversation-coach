...
const TRANSLATIONS: Record<UiLanguage, Record<string, string>> = {
  en: {
    ...
    'annotation.playSnippet': 'Play snippet',
    'annotation.stopSnippet': 'Stop snippet',
    'annotation.playSnippetAria': 'Play the audio snippet for this correction',
    'annotation.stopSnippetAria': 'Stop playback for this correction snippet',
    'annotation.audioUnavailable': 'Audio unavailable for this session.',
    'annotation.audioPlayError': "Couldn't play that snippet — try again.",
  ...
  es: {
    ...
    'annotation.playSnippet': 'Reproducir fragmento',
    'annotation.stopSnippet': 'Detener fragmento',
    'annotation.playSnippetAria': 'Reproducir el fragmento de audio de esta corrección',
    'annotation.stopSnippetAria': 'Detener la reproducción de este fragmento',
    'annotation.audioUnavailable': 'Audio no disponible para esta sesión.',
    'annotation.audioPlayError': 'No se pudo reproducir el fragmento — intentá de nuevo.',
    // Importance pill (replaces the ASCII star cluster)
