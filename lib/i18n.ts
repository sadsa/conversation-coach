...
const TRANSLATIONS: Record<UiLanguage, Record<string, string>> = {
  en: {
    ...
    'voice.firstHint': 'Use ← → to switch corrections. Space to mute, Esc to end.',
  ...
  es: {
    ...
    'voice.firstHint': 'Usá ← → para cambiar de corrección. Espacio para silenciar, Esc para terminar.',
