...
const ICONS = {
  ...
  // Phosphor `caret-down` — used for accordion toggles (CollapsibleGroup).
  // Fill-based 256×256 glyph; uses the complex entry form so the wrapper's
  // stroke defaults don't override the path's fill.
  'caret-down': {
    viewBox: '0 0 256 256',
    node: <path d="M213.66,101.66l-80,80a8,8,0,0,1-11.32,0l-80-80A8,8,0,0,1,53.66,90.34L128,164.69l74.34-74.35a8,8,0,0,1,11.32,11.32Z" fill="currentColor" stroke="none" />,
  },
  'phone-hangup': {
    viewBox: '0 0 256 256',
  ...
  // Filled play-inside-circle — used for the "Practise this phrase" CTA in WriteSheet.
  'play-circle': <>
  ...
  // ── Conversation-starter category glyphs ─────────────────────────────
  // One per category returned by /api/practice-starters. Stroke-based 24px
  // to match the visual weight of mic/book/doc-search above (the icon set
  // mixes Phosphor fills and Lucide-weight strokes; these sit in the latter
  // group). CATEGORY_ICON in PractiseClient.tsx maps category → name here.
  utensils: <>
