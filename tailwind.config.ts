  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        "warning-surface": "var(--color-warning-bg)",
        warning: "var(--color-warning-text)",
        "danger-fill": "var(--color-danger-fill)",
        "danger-fill-hover": "var(--color-danger-fill-hover)",
        "danger-fill-active": "var(--color-danger-fill-active)",
        ...
        "google-surface": "var(--color-google-surface)",
        "google-surface-hover": "var(--color-google-surface-hover)",
        "on-google-surface": "var(--color-on-google-surface)",
